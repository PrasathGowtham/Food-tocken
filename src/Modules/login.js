    ...
    return (
        <div className="loginpage">
            <div>
                ...
                >
                    <span style={{ color: "black" }}> Food Token</span><span style={{ color: 'red' }}>Generator</span>
                </Typography>
            </div>
            ...
            <div>
                ...
                >
                    <div className="formcontainer">
                        ...
                        <br />
                        <Button variant="contained" href="#contained-buttons" onClick={handelSubmit} style={{ marginBottom:"10px" }}>
                            Login
                        </Button>
                        <p>did't have an account?</p>
                        <Button href="#contained-buttons" onClick={() => navigate("/signup")}>
                            Signup
                        </Button>
                        <p>
